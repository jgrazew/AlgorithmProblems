...
public:
    bool canFinish(int numCourses, vector<vector<int>>& prerequisites) {
        ...
        //i think that we could create the vector of in degree's in the for loop above
        //with out creating the graph but I wanted to create the graph first for practice 
